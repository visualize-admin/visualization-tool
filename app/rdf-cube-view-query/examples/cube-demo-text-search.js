...
async function main() {
  ...
  // it's also possible to use the Stardog full text search feature
  const roomLabelTextSearchFilter = roomLabelDimension.filter.stardogTextSearch(
    ["Raum 12*"]
  );
  ...
  customView
    ...
    .addFilter(roomLabelTextSearchFilter);
