...
export const IconArrowDown = ({ size = 24, color = "currentColor" }) => (
  <svg width={size} height={size} viewBox="0 0 32 32">
    <g
      transform="translate(-144 -974) translate(0 240) translate(0 390) translate(16 96) translate(128 248) rotate(90 16 16)"
      stroke="none"
      strokeWidth={1}
      fill="none"
      fillRule="evenodd"
