...
const mockDimensions: Record<string, Dimension> = {
  geoCoordinates: {
    ...
    isKeyDimension: true,
    values: [],
    id: "https://cube-iri___geo-coordinates-dimension-iri",
    isNumerical: false,
  ...
  ordinal: {
    ...
    isKeyDimension: true,
    values: [],
    id: "https://cube-iri___ordinal-dimension-iri",
    isNumerical: true,
  ...
  temporal: {
    ...
    id: "https://cube-iri___temporal-dimension-iri",
    isNumerical: true,
  ...
  temporalOrdinal: {
    ...
    isKeyDimension: true,
    values: [],
    id: "https://cube-iri___temporal-ordinal-dimension-iri",
    isNumerical: true,
  ...
  ordinal2: {
    ...
    isKeyDimension: true,
    values: [],
    id: "https://cube-iri___ordinal-dimension-2-iri",
    isNumerical: false,
