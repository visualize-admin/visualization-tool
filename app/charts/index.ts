...
const chartConfigsAdjusters: ChartConfigsAdjusters = {
  column: {
    ...
    fields: {
      ...
      segment: ({ oldValue, oldChartConfig, newChartConfig, measures }) => {
  ...
  scatterplot: {
    ...
    fields: {
      ...
      segment: ({ oldValue, oldChartConfig, newChartConfig }) => {
...
const convertTableFieldsToSegmentFields = ({
  fields,
}: {
  fields: TableFields;
