...
export type ResolversTypes = ResolversObject<{
  ...
  Component:
    | ResolversTypes["NominalDimension"]
    | ResolversTypes["OrdinalDimension"]
    | ResolversTypes["TemporalDimension"]
    | ResolversTypes["Measure"]
...
export type ResolversParentTypes = ResolversObject<{
  ...
  Component:
    | ResolversParentTypes["NominalDimension"]
    | ResolversParentTypes["OrdinalDimension"]
    | ResolversParentTypes["TemporalDimension"]
    | ResolversParentTypes["Measure"]
...
> = ResolversObject<{
  ...
  observations?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<DataCubeObservationsArgs, never>
  >;
  dimensions?: Resolver<
  ...
  dimensionByIri?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<DataCubeDimensionByIriArgs, "iri">
  >;
  measures?: Resolver<
...
export type DimensionValueResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["DimensionValue"] = ResolversParentTypes["DimensionValue"]
> = ResolversObject<{
...
> = ResolversObject<{
  __resolveType: TypeResolveFn<
    "NominalDimension" | "OrdinalDimension" | "TemporalDimension",
    ParentType,
    ContextType
  >;
  iri?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
...
> = ResolversObject<{
  dataCubeByIri?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<QueryDataCubeByIriArgs, "iri">
  >;
  dataCubes?: Resolver<
    Array<ResolversTypes["DataCubeResult"]>,
    ParentType,
    ContextType,
    RequireFields<QueryDataCubesArgs, never>
  >;
}>;
