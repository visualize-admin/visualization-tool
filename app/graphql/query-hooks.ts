...
export type DataCubesQuery = {
  ...
  dataCubes: Array<{
    ...
    dataCube: {
      ...
      iri: string;
      title: string;
      workExamples?: Maybe<Array<Maybe<string>>>;
...
type DimensionMetadata_GeoCoordinatesDimension_Fragment = {
  ...
  unit?: Maybe<string>;
  related?: Maybe<
    Array<{ __typename: "RelatedDimension"; iri: string; type: string }>
  >;
...
export type DimensionMetadataFragment =
...
export type DataCubeMetadataWithComponentValuesQuery = {
  ...
  dataCubeByIri?: Maybe<{
    ...
    workExamples?: Maybe<Array<Maybe<string>>>;
    landingPage?: Maybe<string>;
    creator?: Maybe<{ __typename: "DataCubeOrganization"; iri: string }>;
    dimensions: Array<
      | ({
          __typename: "GeoCoordinatesDimension";
        } & DimensionMetadata_GeoCoordinatesDimension_Fragment &
...
type HierarchyMetadata_GeoShapesDimension_Fragment = {
  __typename: "GeoShapesDimension";
  hierarchy?: Maybe<
    Array<
      {
...
type HierarchyMetadata_NumericalMeasure_Fragment = {
  __typename: "NumericalMeasure";
  hierarchy?: Maybe<
    Array<
      {
...
type HierarchyMetadata_OrdinalDimension_Fragment = {
  __typename: "OrdinalDimension";
  hierarchy?: Maybe<
    Array<
      {
...
type HierarchyMetadata_OrdinalMeasure_Fragment = {
  __typename: "OrdinalMeasure";
  hierarchy?: Maybe<
    Array<
      {
...
type HierarchyMetadata_TemporalDimension_Fragment = {
  __typename: "TemporalDimension";
  hierarchy?: Maybe<
    Array<
      {
...
export type HierarchyMetadataFragment =
  | HierarchyMetadata_GeoCoordinatesDimension_Fragment
  | HierarchyMetadata_GeoShapesDimension_Fragment
  | HierarchyMetadata_NominalDimension_Fragment
  | HierarchyMetadata_NumericalMeasure_Fragment
...
export type HierarchyValueFieldsFragment = {
  __typename: "HierarchyValue";
  value: string;
  dimensionIri: string;
  depth: number;
...
export type DatasetCountQuery = {
  __typename: "Query";
  datasetcount?: Maybe<
    Array<{ __typename: "DatasetCount"; count: number; iri: string }>
  >;
};
...
export function useTemporalDimensionValuesQuery(
  options: Omit<
    Urql.UseQueryArgs<TemporalDimensionValuesQueryVariables>,
    "query"
  > = {}
) {
  return Urql.useQuery<TemporalDimensionValuesQuery>({
    query: TemporalDimensionValuesDocument,
    ...options,
  });
}
...
export function useOrganizationsQuery(
  ...
  return Urql.useQuery<OrganizationsQuery>({
...
export function useSubthemesQuery(
  options: Omit<Urql.UseQueryArgs<SubthemesQueryVariables>, "query"> = {}
) {
  return Urql.useQuery<SubthemesQuery>({
    query: SubthemesDocument,
    ...options,
  });
}
...
export function useDimensionHierarchyQuery(
  options: Omit<
    Urql.UseQueryArgs<DimensionHierarchyQueryVariables>,
    "query"
  > = {}
) {
  return Urql.useQuery<DimensionHierarchyQuery>({
...
export function useDatasetCountQuery(
  options: Omit<Urql.UseQueryArgs<DatasetCountQueryVariables>, "query"> = {}
) {
  return Urql.useQuery<DatasetCountQuery>({
    query: DatasetCountDocument,
    ...options,
  });
}
