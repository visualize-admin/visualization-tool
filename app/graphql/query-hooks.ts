...
export type DataCubeObservationsPaginatedQueryVariables = Exact<{
  sourceType: Scalars['String'];
  sourceUrl: Scalars['DataSourceUrl'];
  locale: Scalars['String'];
  cubeFilter: DataCubeObservationFilter;
...
export const DataCubeObservationsPaginatedDocument = gql`
    query DataCubeObservationsPaginated($sourceType: String!, $sourceUrl: DataSourceUrl!, $locale: String!, $cubeFilter: DataCubeObservationFilter!) {
  dataCubeObservationsPaginated(
    sourceType: $sourceType
    sourceUrl: $sourceUrl
    locale: $locale
    cubeFilter: $cubeFilter
...
export function useDataCubeObservationsPaginatedQuery(options: Omit<Urql.UseQueryArgs<DataCubeObservationsPaginatedQueryVariables>, 'query'> = {}) {
  return Urql.useQuery<DataCubeObservationsPaginatedQuery>({ query: DataCubeObservationsPaginatedDocument, ...options });
};
