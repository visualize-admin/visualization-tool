> We aspire to adhere to the fundamental design regulations, as described in the «Confederation Web Guidelines». The goal is to establish a visual coherence between the Visualization Tool and other websites within the admin.ch domain. 
