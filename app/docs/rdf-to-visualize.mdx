...
- **Numeric Measure** if `isMeasureDimension = true`, else
...
<TableSpecimen
  ...
  rows={[
    ...
    { "Chart Type": "Column", Conditions: `- 1 or more **Numeric Measures**` },
    {
      "Chart Type": "Lines",
      Conditions: `- 1 or more **Numeric Measures**
...
- 1 or more **Temporal Dimensions**`,
    ...
    { "Chart Type": "Pie", Conditions: "- 1 or more **Numeric Measures**" },
    {
      "Chart Type": "Scatterplot",
      Conditions: "- 2 or more **Numeric Measures**",
    },
