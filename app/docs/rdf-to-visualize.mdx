...
ℹ️ Temporal dimensions can be interactively filtered with a _time range slider_. **Important note**: in order to be able to properly parse temportal dimension, make sure it's scale it set to Interval!
