...
Used for determinations of which chart is possible. See [chart types](/docs#/charts/types) documentation
...
| RDF                                                             | Visualize      |
| :-------------------------------------------------------------- | :------------- |
| `?dimension cube:meta/dataKind time:GeneralDateTimeDescription` | Time           |
| `?dimension cube:meta/dataKind schema:GeoCoordinates`           | GeoCoordinates |
| `?dimension cube:meta/dataKind schema:GeoShape`                 | GeoShape       |
